...
namespace b2.Controllers
{
    public class InterventionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DescriptionIntervention,DeuxiemeIntervention")] Intervention intervention)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DescriptionIntervention,DeuxiemeIntervention")] Intervention intervention)
        {
